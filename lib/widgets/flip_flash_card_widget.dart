...
//           onTap: () => _flipCard(),
//           child: FlippableBox(
//             front: _buildCard(this.widget.flashCard.questionText, 'front supporting text', 500, 250,
//                 Colors.green, true, ''),
//             back: _buildCard(this.widget.flashCard.solutionText, 'back supporting text', 500, 250,
//                 Colors.red, false, ''),
//             flipVt: false,
...
//     String imagePath,
//   ) {
//     bool _renderRichMedia = imagePath != '';
